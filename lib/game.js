...
Game = (function() {
  ...
  Game.prototype.event_coord = function(e) {
    var col, left, offset, row, top;
    offset = $(this.canvas).offset();
    left = e.pageX - offset.left;
    top = this.height - (e.pageY - offset.top);
  ...
  Game.prototype.mousedown = function(e) {
    var col, left, offset, piece, ref, row, top;
    ref = this.event_coord(e), col = ref[0], row = ref[1];
    if (this.board.cols[col][row]) {
      piece = this.board.cols[col][row];
      piece.dragging = true;
      this.dragging = piece;
      offset = $(this.canvas).offset();
      left = (e.pageX - offset.left) % this.scale;
      top = (e.pageY - offset.top) % this.scale;
  ...
  Game.prototype.dragging_render = function(offset_left, offset_top) {
    return (function(_this) {
      return function(e) {
        ...
        if (e) {
          _this.lastmouse = [e.pageX, e.pageY];
        }
        if (_this.dragging) {
