...
Game = (function() {
  function Game(canvas) {
    ...
    this.canvas.addEventListener((Modernizr.touch ? "touchstart" : "mousedown"), this.mousedown);
    this.canvas.addEventListener((Modernizr.touch ? "touchend" : "mouseup"), this.mouseup);
  }
